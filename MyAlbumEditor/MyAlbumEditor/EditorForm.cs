...
namespace MyAlbumEditor
{
    public partial class EditorForm : Form
    {
        ...
        private void DisplayAlbum()
        {
            ...
            else
            {
                ...
                if (Manager.Album.PhotoDescriptor == PhotoAlbum.DescriptorOption.DateTaken)
                    lstPhotos.FormatString = "dMMM dd, yyyy";
        ...
        private void btnMoveUp_Click(object sender, EventArgs e)
        {
            ...
            ReselectMoveItems(newIndices);
        }
        private void ReselectMoveItems(int[] newIndices)
        {
            DisplayAlbum();
            // Reselect move items
        ...
        private void btnRemove_Click(object sender, EventArgs e)
        {
            ...
            DialogResult result = MessageBox.Show(msg, "Remove Photo?",
        ...
        private void btnBrowse_Click(object sender, EventArgs e)
        {
            ...
            {
                dlg.Description = "Select an album file directory to ad to the dialog";
